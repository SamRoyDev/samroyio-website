...
●	Led a 21-person org running Software Development, DevOps, and IT Engineering / Operations / Support.
●	Developed and operated an annual budget of over $5M and continuously increased operational leverage.
...
●	Developed in-house patient appointment reminder system that delivers 28,000+ reminders per month.
●	Automated complex business processes that resulted in more than 5,000 labor hours saved per year and increasing.
...
●	Designed in-house secure patient shared doc “portal” experience that services more than 3,600 new families annually.
●	Pioneered device configuration and security compliance program for 2000+ registered devices.
●	Built a multi-regional service desk that fields more than 20,000 tickets per year.
●	Established 12 new offices and orchestrated technology side of 2 business acquisitions.
